...
This chart labels the application namespace with `istio-injection: enabled` so pods are mesh-ready and receive Istio sidecars when the namespace is created or refreshed.
